...
const runAction = async (
    ...
    if (!issue) {
        if (context.event && content.event.project_card && content.event.project_card.content_url && content.event.project_card.content_url.includes('issues')) {
