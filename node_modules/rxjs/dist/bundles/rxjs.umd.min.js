...
(function (g, w) {
                    ...
                    switch (c[0]) {
                        ...
                        default:
                            ...
                            if (
                                ...
                                (e.label = l[1]), (l = c);
                            else if (l && e.label < l[2])
                                (e.label = l[2]), e.ops.push(c);
                            else {
                                l[2] && e.ops.pop();
                                e.trys.pop();
                                continue;
    ...
    function A(b, a, c) {
        if (c || 2 === arguments.length)
            for (var d = 0, e = a.length, f; d < e; d++)
                (!f && d in a) ||
                    (f || (f = Array.prototype.slice.call(a, 0, d)),
                    (f[d] = a[d]));
    ...
    function Ca(b) {
        if (T.useDeprecatedSynchronousErrorHandling) {
            ...
            if (
                a &&
                ((a = W), (b = a.errorThrown), (a = a.error), (W = null), b)
            )
                throw a;
        } else b();
    }
    ...
    function ae(b) {
        var a;
        (a = b && b instanceof ma) ||
            (a = b && p(b.next) && p(b.error) && p(b.complete) && Gb(b));
        return a;
    }
    function n(b) {
        return function (a) {
    ...
    function Sb(b, a) {
        return new q(function (c) {
            ...
            return function () {
                return (
                    p(null === d || void 0 === d ? void 0 : d.return) &&
                    d.return()
                );
            };
        });
    ...
    function Ub(b, a) {
        if (null != b) {
            ...
            if (Za(b)) return he(b, a);
            if (p(null === b || void 0 === b ? void 0 : b.then))
                return u(b).pipe(qa(a), pa(a));
    ...
    function bb(b, a) {
        ...
        return n(function (a, b) {
            ...
            t(null != c ? ('number' === typeof c ? c : +c - h.now()) : d);
        });
    }
    function ie(b) {
        throw new Wb(b);
    ...
    function Z(b) {
        return 1 === b.length && ve(b[0]) ? b[0] : b;
    }
    function ec() {
        for (var b = [], a = 0; a < arguments.length; a++) b[a] = arguments[a];
        var c = Z(b);
                ...
                new m(
                    ...
                    function (c) {
                        ...
                        if (y)
                            try {
                                for (
                                    var fa = F(y), n = fa.next();
                                    !n.done;
                                    n = fa.next()
                                )
                                    (t = n.value), P(e, t), d.next(t);
                            } catch (J) {
                                g = { error: J };
                            } finally {
                                try {
            ...
            : n(function (a, b) {
                  var e = 0,
                      ...
                      k = function () {
                          ...
                          f = null;
                          if (null != d) {
                              var a = 'number' === typeof d ? Y(d) : u(d(e)),
                                  c = new m(b, function () {
                                      c.unsubscribe();
                                      g();
                                  });
            ...
            a.subscribe(
                new m(
                    ...
                    function (l) {
                        f = !0;
                        if (!b || b(l, h++, a))
                            d && c.error(new hd('Too many matching values')),
                                (d = !0),
                                (e = l);
                    },
                    function () {
                        d
                            ? (c.next(e), c.complete())
                            : c.error(
                                  f ? new id('No matching values') : new ba()
                              );
                    }
                )
            );
            ...
            c.subscribe(
                new m(
                    ...
                    function (a) {
                        ...
                        l = a;
                        (!g || g.closed) &&
                            (e ? n() : (g = u(b(a)).subscribe(new m(d, r, y))));
                    },
                    function () {
                        v = !0;
        ...
        return n(function (a, e) {
            ...
            a.subscribe(
                new m(e, function (a) {
                    k &&
                        ((a = A([a], z(h))),
                        e.next(c ? c.apply(void 0, A([], z(a))) : a));
                })
            );
        });
    }
    ...
    function Me(b) {
        return new q(function (a) {
            ...
            if (g)
                for (var r in g)
                    g.hasOwnProperty(r) && (f[r.toLowerCase()] = g[r]);
            var n = e.crossDomain;
            n ||
                'x-requested-with' in f ||
                (f['x-requested-with'] = 'XMLHttpRequest');
            var x = e.xsrfCookieName,
                g = e.xsrfHeaderName;
            (e.withCredentials || !n) &&
                x &&
                g &&
                ...
                (f[g] = n);
            c = Ne(h, f);
            var p = V(V({}, e), { url: k, headers: f, body: c }),
                t;
            t = b.createXHR ? b.createXHR() : new XMLHttpRequest();
            var q = b.progressSubscriber,
            ...
            h = function (b, c) {
                t.addEventListener(b, function () {
                    var b,
                        d = c();
                    null ===
                        (b = null === q || void 0 === q ? void 0 : q.error) ||
                    void 0 === b
                        ? void 0
                        : b.call(q, d);
                    a.error(d);
            ...
            t.addEventListener('error', function (a) {
                var b;
                null === (b = null === q || void 0 === q ? void 0 : q.error) ||
                void 0 === b
                    ? void 0
                    : b.call(q, a);
                J();
            ...
            t.addEventListener(Ld, function (b) {
                ...
                if (400 > e) {
                    null ===
                        (c =
                            null === q || void 0 === q ? void 0 : q.complete) ||
                    void 0 === c
                        ? void 0
                        : c.call(q);
                    c = void 0;
    ...
    var Ra = function (b, a) {
        ...
        ma = (function (b) {
            ...
            a.prototype.next = function (a) {
                this.isStopped ? Ua(K('N', a, void 0), this) : this._next(a);
            };
            a.prototype.error = function (a) {
                this.isStopped
                    ? Ua(K('E', void 0, a), this)
        ...
        wa = (function (b) {
            function a(a, d, e) {
                ...
                c.destination = {
                    next: h ? Ta(h, c) : B,
                    error: Ta(null !== d && void 0 !== d ? d : Ib, c),
                    complete: e ? Ta(e, c) : B
                };
                return c;
            }
        ...
        Qe = { closed: !0, next: B, error: Ib, complete: B },
        oa =
        ...
        Pa = (function (b) {
            function a(a, d) {
                ...
                c._refCount = 0;
                c._connection = null;
                p(null === a || void 0 === a ? void 0 : a.lift) &&
                    (c.lift = a.lift);
                return c;
            }
            w(a, b);
        ...
        C = (function (b) {
            ...
            a.prototype.error = function (a) {
                ...
                Ca(function () {
                    ...
                    if (!b.isStopped) {
                        ...
                        b.thrownError = a;
                        for (var c = b.observers; c.length; )
                            c.shift().error(a);
                    }
                });
            };
            a.prototype.complete = function () {
                ...
                Ca(function () {
                    ...
                    if (!a.isStopped) {
                        a.isStopped = !0;
                        for (var b = a.observers; b.length; )
                            b.shift().complete();
                    }
                });
            };
            ...
            a.prototype._execute = function (a, b) {
                ...
                try {
                    ...
                    (b = !0),
                        (c = f
                            ? f
                            : Error('Scheduled action threw falsy error'));
                }
        ...
        la = {
            setImmediate: function () {
                ...
                a = la.delegate;
                return (
                    (null === a || void 0 === a ? void 0 : a.setImmediate) || Te
                ).apply(void 0, A([], z(b)));
            },
    ...
    var Na = (function () {
        ...
        se = ['addListener', 'removeListener'],
        qe = ['addEventListener', 'removeEventListener'],
        ue = ['on', 'off'],
        Td = new q(B),
        ve = Array.isArray,
        ye = function (b, a) {
    ...
    var $e = (function (b) {
            ...
            a.prototype.materializeInnerObservable = function (a, b) {
                ...
                a.subscribe(
                    function (a) {
                        d.push({
                            frame: c.frame - b,
                            notification: K('N', a, void 0)
                        });
                    },
                    function (a) {
                        d.push({
                            frame: c.frame - b,
                            notification: K('E', void 0, a)
                        });
                    },
                    function () {
        ...
        af = Object.freeze({ TestScheduler: $e }),
        xb = (function () {
        ...
        Wd = (function (b) {
            function a(a, d) {
                var c = b.call(this) || this;
                c._socket = null;
                if (a instanceof q) (c.destination = d), (c.source = a);
                else {
                    d = c._config = V({}, cf);
                    c._output = new C();
