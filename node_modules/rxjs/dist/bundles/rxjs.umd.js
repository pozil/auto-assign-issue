    ...
    ***************************************************************************** */
    ...
    var AsapAction = (function (_super) {
        ...
        AsapAction.prototype.recycleAsyncId = function (scheduler, id, delay) {
            ...
            if (
                !scheduler.actions.some(function (action) {
                    return action.id === id;
                })
            ) {
            ...
            var subscribeNext = function () {
                if (!subscriber.closed) {
                    if (remaining.length > 0) {
                        ...
                        var innerSub = createOperatorSubscriber(
                            subscriber,
                            undefined,
                            noop,
                            noop
                          ...
                          createOperatorSubscriber(
                              ...
                              function (value) {
                                  ...
                                  if (
                                      ...
                                      var result = buffers.map(function (
                                          buffer
                                      ) {
                                          return buffer.shift();
                                      });
    ...
    var TestScheduler = (function (_super) {
        ...
        TestScheduler.prototype.createDelegates = function () {
            ...
            var run = function () {
                ...
                var scheduledRecordsDue = scheduledRecords.filter(function (
                    _a
                ) {
                    var due = _a.due;
                    return due <= now;
        ...
        return new Observable(function (destination) {
            ...
            if (queryParams) {
                ...
                if (url.includes('?')) {
                    ...
                    new URLSearchParams(queryParams).forEach(function (
                        value,
                        key
                    ) {
